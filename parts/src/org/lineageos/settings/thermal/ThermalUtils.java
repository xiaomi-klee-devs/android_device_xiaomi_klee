...
public final class ThermalUtils {
    ...
    private static final String THERMAL_STATE_DIALER    = "5";   // thermal-phone.conf
    private static final String THERMAL_STATE_GAMING    = "18";   // thermal-tgame.conf
    private static final String THERMAL_STATE_STREAMING = "14";  // thermal-videochat.conf
